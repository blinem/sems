...
public class NdryshoFjalkalimin extends JFrame {
	...
	public NdryshoFjalkalimin(Student stud) {
		...
		konfirmoBt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(!fjalkalimiVjeterPf.getText().equals(stud.getFjalkalimi())) {
				...
				StudentFile.nderroFjalkalimin(fjalkalimiRiPf.getText(), stud);
				dispose();
				}
			}
		});
